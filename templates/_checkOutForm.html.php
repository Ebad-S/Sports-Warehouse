...
<form class="contact" action="checkout.php" method="post" nonvalidate>
    <fieldset>
        ...
        <div class="form-row">
            ...
            <select name="course" id="course">
                ...
                <option value="mastercard" <?= setSelected("Payment", "mastercard") ?>>Mastercard</option>
            </select>
        </div>
        <div class="form-row">
        ...
        <div class="form-row">
            <button class="submitbtn" type="submit" name="submitcheckout">Submit</button>
        </div>
    </fieldset>
</form>