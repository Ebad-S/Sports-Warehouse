...
?><h2 class="subhead">Add a New Product</h2>

<p class="messagebox">Please fill out the form to add a new product.</p>

<?php include "_formErrorSummary.html.php" ?>

<form action="addProduct.php" method="post" enctype="multipart/form-data" novalidate>
    <fieldset>
        <legend class="legend-name">Add New Product</legend>

        <div class="form-row">
            <label for="itemName">item Name:</label>
            <input type="text" name="itemName" id="itemName" maxlength="150" required autofocus
                <?= setValue("itemName") ?>>
        </div>
        ...
        <div class="form-row">
            ...
            <input type="number" name="price" id="price" min="1" aria-label="price" title="price"
                <?= setValue("price") ?>>
        </div>
        ...
        <div class="form-row">
            <button class="addProduct" type="submit" name="submitAddProduct">Add Product</button>
        </div>
